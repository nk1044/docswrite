...
const metaData = [
    ...
    {data: 'Git Init Status Commit Log', Index: 2, ID: 'git-basics'},
    ...
    {data: 'Git Remote Add Origin', Index: 2, ID: 'github-setup'},
    ...
    {data: 'Server Monitoring', Index: 8, ID: 'server-monitoring-overview'},
    {data: 'Server Monitoring Overview', Index: 8, ID: 'server-monitoring-overview'},
    {data: 'Prometheus Grafana Loki', Index: 8, ID: 'server-monitoring-overview'},
    {data: 'Server Monitoring Why this stack', Index: 8, ID: 'server-monitoring-why-this-stack'},
    {data: 'Server Monitoring | Prometheus Grafana Loki Prerequisites', Index: 8, ID: 'server-monitoring-prerequisites'},
    {data: 'Server Monitoring | Prometheus Grafana Loki Architecture Overview', Index: 8, ID: 'server-monitoring-architecture-overview'},
    {data: 'Server Monitoring Prometheus Setup', Index: 8, ID: 'server-monitoring-prometheus-client'},
    {data: 'Server Monitoring Prometheus Client Setup', Index: 8, ID: 'server-monitoring-prometheus-client'},
    {data: 'Server Monitoring Prometheus Client Registry Setup', Index: 8, ID: 'server-monitoring-prometheus-client'},
    {data: 'Server Monitoring Prometheus Metrics Collection | Collect Metrics', Index: 8, ID: 'server-monitoring-prometheus-client'},
    {data: 'Server Monitoring Prometheus Custom Metrics | Custom Metrics', Index: 8, ID: 'server-monitoring-prometheus-custom-metrics'},
    {data: 'Server Monitoring Prometheus Custom Metrics | Histogram', Index: 8, ID: 'server-monitoring-prometheus-custom-metrics'},
    {data: 'Server Monitoring Prometheus Custom Metrics | Gauge', Index: 8, ID: 'server-monitoring-prometheus-custom-metrics'},
    {data: 'Server Monitoring Prometheus Custom Metrics | Request Counter', Index: 8, ID: 'server-monitoring-prometheus-custom-metrics'},
    {data: 'Server Monitoring Prometheus Server Setup ', Index: 8, ID: 'server-monitoring-setup-prometheus-server'},
    {data: 'Server Monitoring Prometheus Server Setup | Docker Compose', Index: 8, ID: 'server-monitoring-setup-prometheus-server'},
    {data: 'Server Monitoring Prometheus Config | prometheus-config.yml', Index: 8, ID: 'server-monitoring-setup-prometheus-server'},
    {data: 'Server Monitoring Grafana', Index: 8, ID: 'server-monitoring-setup-grafana'},
    {data: 'Server Monitoring Grafana | Metrics Visualization', Index: 8, ID: 'server-monitoring-setup-grafana'},
    {data: 'Server Monitoring Grafana | Docker Compose Setup', Index: 8, ID: 'server-monitoring-setup-grafana'},
    {data: 'Server Monitoring Grafana | Prometheus', Index: 8, ID: 'server-monitoring-setup-grafana'},
    {data: 'Server Monitoring Grafana | DashBoard Creation', Index: 8, ID: 'server-monitoring-setup-grafana'},
    {data: 'Server Monitoring Loki', Index: 8, ID: 'server-monitoring-setup-loki'},
    {data: 'Server Monitoring Loki | Log Monitoring', Index: 8, ID: 'server-monitoring-setup-loki'},
    {data: 'Server Monitoring Loki | Log Monitoring | Prometheus', Index: 8, ID: 'server-monitoring-setup-loki'},
    {data: 'Server Monitoring Custom DashBoards', Index: 8, ID: 'server-monitoring-unified-dashboards'},
    {data: 'Server Monitoring Custom DashBoards | Prometheus | Loki | Grafana', Index: 8, ID: 'server-monitoring-unified-dashboards'},
    {data: 'Server Monitoring Alerts', Index: 8, ID: 'server-monitoring-alerts'},
    {data: 'Server Monitoring Alerts | Prometheus', Index: 8, ID: 'server-monitoring-alerts'},
    {data: 'Server Monitoring Best Practices | Prometheus', Index: 8, ID: 'server-monitoring-best-practices'},
    {data: 'Server Monitoring Best Practices | Grafana', Index: 8, ID: 'server-monitoring-best-practices'},
    {data: 'Server Monitoring Best Practices | Loki', Index: 8, ID: 'server-monitoring-best-practices'},
    {data: 'Server Monitoring troubleshooting | Prometheus', Index: 8, ID: 'server-monitoring-troubleshooting'},
